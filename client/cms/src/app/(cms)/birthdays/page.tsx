      ...
      <div className="page-header">
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', flexWrap: 'wrap', gap: 16 }}>
          <div>
            ...
            <h1 className="page-title">Birthdays This Month</h1>
            <p className="page-subtitle">
              {outletId ? 'Filtered by outlet — ' : ''}
              {!loading ? `${customers.length} customer${customers.length !== 1 ? 's' : ''}` : 'Loading birthdays…'}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="page-content">
        ...
        {error && (
          <div className="empty-state">
            ...
            <div className="empty-state-title">Failed to load birthdays</div>
        ...
        {!loading && !error && customers.length === 0 && (
          <div className="empty-state">
            ...
            <div className="empty-state-desc">
              There are no customers celebrating their birthdays in the current calendar month.
            </div>
          </div>
        )}
