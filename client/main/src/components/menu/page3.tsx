...
import { palgharMenu, type MenuEntry } from './palgharmenu'
...
export default function PalgharMenuPage() {
  const [vegOnly, setVegOnly] = useState(false)
  const [search, setSearch] = useState('')

  const filtered = palgharMenu.filter((item) => {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6">
      <div className="mb-5">
        <h1 className="text-2xl font-bold text-secondary mb-1">Napkiq Palghar</h1>
